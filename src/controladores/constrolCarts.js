...
const getCartById = async (req, res) => {
  ...
  // Funccion parar crear un carrito
const postCart = async (req, res) => {
  ...
  //Funcion para agregar producto a un carrito
...
//Funccion parar eleminar producto de un carrito
const deleteCartsById = async(req, res) => {
    ...
    try {
      ...
      if (productToEliminar !== -1) {
        ...
        const productToUpdate = await productModel.findById(removedProduct.productId);
        if(productToUpdate){
...
//Funcion que edita cantidad o agrega producto del carrito
